...
const page = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="text-2xl font-extrabold title-font mb-4 text-white ">OUR TEAM</h1>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <Image alt="dummy1" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={dummy1}/>
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <Image alt="dummy2" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={dummy2}/>
          <div className="w-full">
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <Image alt="dummy3" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={dummy3}/>
          <div className="w-full">
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <Image alt="dummy4" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={dummy4}/>
          <div className="w-full">
